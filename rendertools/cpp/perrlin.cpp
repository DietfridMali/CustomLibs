...
static inline grad3 PermGradient(int x, int y, int z, const std::vector<int>& perm, int period) {
...
static inline float DotPermGradient(int ix, int iy, int iz, float x, float y, float z, const std::vector<int>& perm, int period) {
...
float ImprovedPerlinNoise(float x, float y, float z, const std::vector<int>& perm, int period) {
