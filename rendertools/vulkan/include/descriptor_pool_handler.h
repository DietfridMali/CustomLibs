...
//   kMaxStoragePerPool   — STORAGE_BUFFER slot count (u0..u3 + t0..t16 space1 per draw)
//
...
public:
    ...
    static constexpr uint32_t kMaxStoragePerPool = kMaxSetsPerPool * 21;  // u0..u3 + t0..t16 space1 per set (StorageBuffer)
