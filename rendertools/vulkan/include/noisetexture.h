...
// =================================================================================================
// Vulkan-specific noise texture subclasses. Class names match the historical API. All common code
// lives in BaseNoiseTexture* / BaseCloudNoiseTexture / BaseBlueNoiseTexture; this header adds only
// the VK-specific Deploy + SetParams overrides plus the factory hooks for the CloudNoise mip
// pyramid.
